...
# En entrée : un jeu de données spécifique, un nombre de tâche souhaité
# En sortie : des tâches, le nombre final de feature et de label final pour le jeu de données
